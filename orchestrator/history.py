...
def record_from_execution(envelope: ExecutionEnvelope) -> HistoryRecord:
    return HistoryRecord(
        ...
        gate_status=envelope.quality_gates.gate_status if envelope.quality_gates else None,
...
def record_from_report(report: StandardReport) -> HistoryRecord:
    return HistoryRecord(
        ...
        gate_status=report.quality_gates.gate_status if report.quality_gates else None,
        support_level=report.support_level,
        environment_type=str(report.environment_summary.get("type")) if report.environment_summary else None,
